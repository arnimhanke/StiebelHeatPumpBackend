...
public class DisplayedNames {
    ...
    static {
        ...
        MAP_ES_INDEX_TO_DISPLAYED_NAME.put(ES_INDEX_PREFIX + ES_TYPE_IA_RÜCKLAUFISTTEMPERATUR.toLowerCase(), "IA Rücklauftemperatur");
        ...
        MAP_ES_INDEX_TO_DISPLAYED_NAME.put(ES_INDEX_PREFIX + ES_TYPE_IA_SOLLTEMPERATUR_GEBLÄSE.toLowerCase(), "IA Solltemperatur Gebläse");
        MAP_ES_INDEX_TO_DISPLAYED_NAME.put(ES_INDEX_PREFIX + ES_TYPE_IA_ISTTEMPERATUR_GEBLÄSE.toLowerCase(), "IA Isttemperatur Gebläse");
        ...
        MAP_ES_INDEX_TO_DISPLAYED_NAME.put(ES_INDEX_PREFIX + ES_TYPE_IW_VD_KÜHLEN.toLowerCase(), "Küh h Sum");
        ...
        MAP_ES_INDEX_TO_DISPLAYED_NAME.put(ES_INDEX_PREFIX + ES_TYPE_IW_NHZ_1_DURCH_2.toLowerCase(), "NHz 1 2");
